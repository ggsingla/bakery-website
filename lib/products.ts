...
export const products: Product[] = [
  {
    ...
    images: [
      '/elegant-chocolate-cake-with-ganache.jpg',
      '/chocolate-cake-slice-closeup.jpg',
      '/chocolate-cake-top-view.jpg',
    ],
    ingredients: [
      'Premium cocoa',
      'Fresh eggs',
  ...
  },
  {
    ...
    category: 'cakes',
    description:
      'Light and fluffy vanilla cake made with real vanilla beans, topped with silky buttercream frosting.',
    price: 42.0,
    image: '/elegant-vanilla-cake-with-buttercream.jpg',
    images: [
      '/elegant-vanilla-cake-with-buttercream.jpg',
      '/vanilla-cake-slice.jpg',
    ],
  ...
  },
  {
    ...
    category: 'biscuits',
    description:
      'Crispy, golden butter biscuits with a delicate crunch. Perfect with your afternoon tea.',
    price: 12.0,
  ...
  },
  {
    ...
    category: 'biscuits',
    description:
      'Classic chocolate chip cookies loaded with premium chocolate chunks. Soft center with crispy edges.',
    price: 14.0,
  ...
  },
  {
    ...
    category: 'biscuits',
    description:
      'Traditional Italian twice-baked biscuits with roasted almonds. Perfect for dipping in coffee.',
    price: 15.0,
  ...
  },
  {
    ...
    category: 'muffins',
    description:
      'Fluffy muffins bursting with fresh blueberries. Lightly sweetened with a golden top.',
    price: 8.0,
  ...
  },
  {
    ...
    category: 'muffins',
    description:
      'Double chocolate muffins with a tender crumb and rich chocolate flavor.',
    price: 8.0,
  ...
  },
  {
    ...
    category: 'muffins',
    description:
      'Moist banana muffins with crunchy walnuts. Made with ripe bananas for natural sweetness.',
    price: 9.0,
  ...
  },
  {
    ...
    description:
      'Handcrafted dark chocolate truffles with a smooth ganache center. Pure indulgence.',
    price: 18.0,
  ...
  },
  {
    ...
    category: 'chocolate-balls',
    description:
      'Chocolate balls rolled in shredded coconut. A tropical twist on a classic treat.',
    price: 16.0,
  ...
  },
  {
    ...
    category: 'chocolate-balls',
    description:
      'Luxurious chocolate balls filled with hazelnut praline. Elegantly finished with gold dust.',
    price: 20.0,
