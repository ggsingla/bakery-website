...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12" data-aos="fade-up">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12" data-aos="fade-up" data-aos-delay="100">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-foreground mb-4">Contact Us</h1>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">We'd love to hear from you. Send us a message below.</p>
          </div>
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-2 text-xs text-muted-foreground">
                    ...
                    <p>Upload an image to show us your inspiration or reference. Supported formats: PNG, JPG, WebP (max 5MB)</p>
                  </div>
                </div>
