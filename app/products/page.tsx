        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up" data-aos-delay="100">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
              Handcrafted with love using the finest ingredients. Each item is made fresh daily in our bakery.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((product, idx) => (
              <div key={product.id} data-aos="fade-up" data-aos-delay={String(100 + (idx % 4) * 50)}>
