  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <Image src="/bakery-hero-background.jpg" alt="Cake Paradise products" fill className="object-cover" priority />
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto" >
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty" data-aos="fade-up" data-aos-delay="100">
      ...
      {/* Featured Products */}
      <section className="py-20 px-4 sm:px-6 lg:px-8" data-aos="fade-up" data-aos-delay="100">
